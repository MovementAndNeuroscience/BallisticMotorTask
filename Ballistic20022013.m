...
classdef Ballistic < handle
    ...
    properties (Constant, Hidden)
        ...
        MINIMUMPEAKDETECTIONLEVEL = 0.25; % in input device units (v or pixels)
        ...
        DECELERATIONDURATION = 10; % in samples
...
time = time + v;
        ...
        function endOfTrial(this, ~, ~)
            ...
            if (this.running)
                ...
                if ~isempty(this.maxAccelerationDotSubject)
        ...
        function endOfPause(this, ~, ~)
            ...
            if (this.running)
                ...
                set([this.FBBoxes this.FBBlindBox], 'String', '');
        ...
        function result = InitDAQ(this)
            ...
            try
                ...
                a = arrayfun(@(c)subsasgn(c,substruct('.','InputType'),Itype), session.Channels, 'UniformOutput', false);
                session.prepare;
                this.DAQin = session;
            catch e
                result = false;
        ...
        function startExperiment(this)
            ...
            set([this.FBBoxes this.FBBlindBox], 'FontSize', this.FBSize);
